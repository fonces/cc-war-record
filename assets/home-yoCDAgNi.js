...
`;const $=(0,L.memo)(({map:e,title:t,totalMatches:n,totalWins:r,totalDefeats:i,winRate:a,isCurrentMap:o,isNextMap:c,isOpen:l,onToggle:u,usedJobs:d,jobSummaries:f,onAddWin:p,onAddDefeat:m,onRevertLast:h})=>{let{t:g}=s();return(0,z.jsxs)(fe,{children:[(0,z.jsxs)(pe,{onClick:()=>u(e),isCurrentMap:o,children:[(0,z.jsxs)(me,{children:[(0,z.jsx)(ve,{isOpen:l,children:(0,z.jsx)(D,{name:`arrowDropDown`,size:20})}),(0,z.jsx)(`span`,{children:t}),o&&(0,z.jsxs)(le,{children:[(0,z.jsx)(de,{}),`Now`]}),c&&(0,z.jsx)(ue,{children:`Next`})]}),(0,z.jsxs)(he,{children:[(0,z.jsx)(`span`,{children:g(`character.stats.matches`,{count:n})}),(0,z.jsxs)(`span`,{children:[g(`character.stats.wins`,{count:r}),` / `,g(`character.stats.defeats`,{count:i})]}),0<n?(0,z.jsx)(ge,{winRate:a,children:g(`character.stats.winRate`,{rate:a})}):(0,z.jsx)(`span`,{children:g(`character.stats.noWinRate`)})]})]}),(0,z.jsx)(_e,{isOpen:l,children:(0,z.jsx)(Q,{usedJobs:d,jobSummaries:f,onAddWin:p,onAddDefeat:m,onRevertLast:h,map:e})})]})},(e,t)=>e.totalMatches===t.totalMatches&&e.isCurrentMap===t.isCurrentMap&&e.isNextMap===t.isNextMap&&e.isOpen===t.isOpen&&e.onToggle===t.onToggle);$.displayName=`MapSection`;var ye=i.div`
  display: flex;
  flex-direction: column;
  gap: ${({theme:e})=>e.spacing[6]};
`;const be=({usedJobs:e,matchRecords:t,onAddWin:n,onAddDefeat:r,onRevertLast:i})=>{let{t:a}=s(),{currentMap:o,nextMap:c}=h(),u=R(t),d=re(t,e),f=t.length,p=t.filter(e=>e.isWin).length,m=f-p,g=f>0?Math.round(p/f*100):0,[_,v]=(0,L.useState)(()=>new Set([o])),[y,b]=(0,L.useState)(!1),x=(0,L.useCallback)(e=>{let t=new Set(_);t.has(e)?t.delete(e):t.add(e),v(t)},[_]);return(0,z.jsxs)(ye,{children:[u.map(t=>{let s=t.map===o,u=t.map===c;return(0,z.jsx)($,{map:t.map,title:l(t.map,a),totalMatches:t.totalMatches,totalWins:t.totalWins,totalDefeats:t.totalDefeats,winRate:t.mapWinRate,isCurrentMap:s,isNextMap:u,isOpen:_.has(t.map),onToggle:x,usedJobs:e,jobSummaries:t.jobSummaries,onAddWin:n,onAddDefeat:r,onRevertLast:i},t.map)}),(0,z.jsx)($,{title:a(`match.allStagesTotal`),totalMatches:f,totalWins:p,totalDefeats:m,winRate:g,isOpen:y,onToggle:()=>b(!y),usedJobs:e,jobSummaries:d})]})};var xe=i.div`
  background: ${({theme:e})=>e.gradients.glass};
  backdrop-filter: ${({theme:e})=>e.blur.md};
