import{i as e}from"./rolldown-runtime-CIDIeb-o.js";import{T as t,_ as n,g as r,x as i}from"./react-vendor-D1pS86Oe.js";import{s as a}from"./styled-BVM0xVww.js";import"./jszip-DU7jsDXX.js";import"./i18n-THkEc1_o.js";import{A as o,C as s,F as c,I as l,N as u,O as d,P as f,S as p,T as m,_ as h,a as g,b as _,c as v,ct as y,d as b,et as x,f as S,g as C,h as w,k as T,l as E,lt as D,m as O,nt as k,o as A,p as j,q as M,s as N,st as P,t as F,tt as I,u as L,v as R,x as z,y as B}from"./index-Bov6YTpw.js";import{n as V,t as H}from"./stores-843luLyD.js";var U=e(t()),W=e(i()),G=a(O)`
  font-weight: 600;
...
`;const $=()=>{let{t:e,i18n:t}=o();T(e(`pages.histories.title`));let n=d(),{histories:r,isLoading:i,error:a,getSortedHistories:s,deleteHistory:l,clearError:u}=H(),{matchRecords:y}=V(),[x,C]=(0,U.useState)(null),[w,D]=(0,U.useState)(null),[O,M]=(0,U.useState)(!1),R=s(),G=t.language===`ja`?`ja-JP`:t.language===`ko`?`ko-KR`:`en-US`,K=e=>{let t=y.filter(t=>t.seasonUuid===e),{deleteMatchRecord:n}=V.getState();t.forEach(e=>{n(e.uuid)}),l(e),F(`histories`,`delete`)},q=async()=>{try{C(null),D(null),await f(),F(`histories`,`create_backup`),D(e(`pages.histories.backupCreated`))}catch{C(e(`pages.histories.errors.backupCreateFailed`))}},J=()=>{M(!0)},Y=()=>{M(!1);let t=document.createElement(`input`);t.type=`file`,t.accept=`.zip`,t.onchange=async t=>{let n=t.target.files?.[0];if(n)try{C(null),D(null),await c(n),F(`histories`,`restore_backup`),D(e(`pages.histories.backupRestored`)),setTimeout(()=>{window.location.reload()},1500)}catch(t){t instanceof Error&&t.message===`BACKUP_FILE_CORRUPTED`?C(e(`pages.histories.errors.backupFileCorrupted`)):C(e(`pages.histories.errors.backupRestoreFailed`))}},t.click()},X=[{label:e(`pages.histories.createBackup`),icon:`download`,onClick:q},{label:e(`pages.histories.importBackup`),icon:`upload`,onClick:J}];return(0,W.jsxs)(h,{children:[(0,W.jsxs)(p,{children:[(0,W.jsx)(_,{action:n?(0,W.jsx)(A,{items:X,triggerTitle:e(`common.menu`),stopPropagation:!1}):void 0,children:e(`pages.histories.title`)}),!n&&(0,W.jsxs)(z,{children:[(0,W.jsx)(v,{onClick:q,icon:(0,W.jsx)(P,{name:`download`,size:16}),title:e(`pages.histories.createBackup`)}),(0,W.jsx)(v,{onClick:J,icon:(0,W.jsx)(P,{name:`upload`,size:16}),title:e(`pages.histories.importBackup`)})]})]}),(0,W.jsx)(B,{children:e(`pages.histories.description`)}),a&&(0,W.jsx)(N,{type:`error`,onClose:u,children:a}),x&&(0,W.jsx)(N,{type:`error`,onClose:()=>C(null),children:x}),w&&(0,W.jsx)(N,{type:`success`,onClose:()=>D(null),children:w}),0<r.length?(0,W.jsxs)(Q,{children:[(0,W.jsxs)(j,{children:[(0,W.jsxs)(E,{children:[(0,W.jsx)(b,{children:e(`pages.histories.stats`)}),(0,W.jsx)(S,{children:r.length}),(0,W.jsx)(L,{children:e(`pages.histories.totalSeasons`,{count:r.length})})]}),(0,W.jsxs)(E,{children:[(0,W.jsx)(b,{children:e(`pages.histories.latestCreated`)}),(0,W.jsx)(S,{children:k(R[0]?.createdAt,G)}),(0,W.jsx)(L,{children:I(R[0]?.createdAt,G)})]})]}),(0,W.jsx)(Z,{histories:R,isLoading:i,onDelete:K})]}):(0,W.jsx)(g,{icon:`history`}),(0,W.jsx)(m,{isOpen:O,onClose:()=>M(!1),title:e(`pages.histories.importBackupWarningTitle`),onConfirm:Y,confirmText:e(`common.upload`),cancelText:e(`common.cancel`),confirmType:`danger`,children:(0,W.jsx)(`p`,{children:e(`pages.histories.importBackupWarningMessage`)})})]})};var ee=a(O)`
  font-weight: 600;
  color: ${({theme:e})=>e.colors.text};
  position: relative;
  padding-left: calc(${({theme:e})=>e.spacing[6]} + 8px);
