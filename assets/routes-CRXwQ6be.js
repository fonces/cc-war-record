...
`,ze=v.span`
  ...
  color: ${({theme:e})=>e.colors.text};
  text-align: center;
`;const Be=({isOpen:t,onClose:n,onRegister:r,characterUuid:i,historyUuid:a,isLoading:s=!1})=>{let{t:c}=m(),l=k(e=>e.addCharacterStats),u=k(e=>e.getHistoryByUuid),d=te(e=>e.characters),p=u(a)?.characterStats.find(e=>e.character.uuid===i)?.usedJobs||[],h=e=>{if(p.includes(e))return;let t=d.find(e=>e.uuid===i);if(!t){console.error(`キャラクターが見つかりません`);return}l(a,t)&&(r?.(e),n())},_=Object.values(e).map(e=>({role:e,roleInfo:D[e],jobs:Object.values(O).filter(t=>o[t].role===e)}));return(0,P.jsx)(f,{isOpen:t,onClose:n,title:c(`job.selectJob`),isLoading:s,children:(0,P.jsxs)(Ne,{children:[(0,P.jsx)(Pe,{children:c(`job.selectJobDescription`)}),_.map(({role:e,jobs:t})=>(0,P.jsxs)(Fe,{children:[(0,P.jsxs)(Ie,{children:[(0,P.jsx)(b,{role:e,size:24}),c(`job.${e}`)]}),(0,P.jsx)(Le,{children:t.map(e=>{let t=p.includes(e);return(0,P.jsxs)(Re,{isSelected:!1,isDisabled:t,onClick:()=>h(e),type:`button`,disabled:t,children:[(0,P.jsx)(g,{job:e,size:32}),(0,P.jsx)(ze,{children:c(`job.${e}`)})]},e)})})]},e))]})})};var Ve=v.div`
  display: flex;
  flex-direction: column;
  gap: ${({theme:e})=>e.spacing[4]};
  margin-top: ${({theme:e})=>e.spacing[6]};
