...
`;const Y=(0,F.memo)(({type:e,color:t})=>(0,J.jsx)(me,{$color:t,$type:e}));Y.displayName=`Dot`;const X=i.div`
  background: ${({theme:e})=>e.gradients.glass};
