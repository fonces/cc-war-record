import{C as e,E as t,L as n,M as r,O as i,P as a,T as o,_ as s,a as c,b as l,g as u,h as d,i as f,j as p,m,n as h,o as g,p as _,r as v,s as y,t as b,v as x,y as S}from"./index-Br5uo2xh.js";import"./stores-COx9ZclY.js";import{t as ee}from"./EmptyState-CohI2OGc.js";var C=n(a()),w=n(p()),T=r.div`
...
`;const _e=({stats:t,isOpen:n,onToggle:r,onStartEdit:i,onDelete:a,onOpenJobRegistration:o,onAddWin:c,onAddLoss:u,onRevertLast:d,isEditing:f,editingName:p,onEditingNameChange:m,onSaveEdit:h,onCancelEdit:g})=>{let _=x(t.recentMatches),v=l(t.recentMatches),y=s(t.recentMatches),b=S(t.recentMatches);return(0,w.jsxs)(ae,{children:[(0,w.jsx)(oe,{onClick:f?void 0:r,style:{cursor:f?`default`:`pointer`},children:f?(0,w.jsxs)(he,{children:[(0,w.jsx)(ge,{value:p,onChange:e=>m(e.target.value),onKeyDown:e=>{e.key===`Enter`&&h(),e.key===`Escape`&&g()},onClick:e=>e.stopPropagation(),autoFocus:!0}),(0,w.jsxs)(me,{children:[(0,w.jsx)($,{variant:`outline`,icon:(0,w.jsx)(e,{name:`accept`,size:16}),onClick:e=>{e.stopPropagation(),h()},title:`保存`}),(0,w.jsx)($,{variant:`outline`,icon:(0,w.jsx)(e,{name:`close`,size:16}),onClick:e=>{e.stopPropagation(),g()},title:`キャンセル`})]})]}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(se,{children:t.character.name}),(0,w.jsxs)(ce,{onClick:e=>e.stopPropagation(),children:[(0,w.jsxs)(`span`,{children:[_,`試合`]}),(0,w.jsxs)(`span`,{children:[v,`勝`,y,`敗`]}),(0,w.jsxs)(le,{winRate:b,children:[`勝率`,b,`%`]}),(0,w.jsxs)(me,{children:[(0,w.jsx)($,{variant:`outline`,icon:(0,w.jsx)(e,{name:`add`,size:16}),onClick:e=>{e.stopPropagation(),o(t.character.uuid)},title:`ジョブの追加`}),(0,w.jsx)($,{variant:`outline`,icon:(0,w.jsx)(e,{name:`edit`,size:16}),onClick:e=>{e.stopPropagation(),i(t.character.uuid,t.character.name)},title:`キャラクター名の編集`}),(0,w.jsx)($,{variant:`outline`,icon:(0,w.jsx)(e,{name:`delete`,size:16}),onClick:e=>{e.stopPropagation(),a(t.character.uuid,t.character.name)},title:`キャラクターの削除`})]})]})]})}),(0,w.jsx)(ue,{isOpen:n,children:(0,w.jsx)(de,{children:t.usedJobs.length===0?(0,w.jsx)(fe,{children:(0,w.jsx)(pe,{onClick:()=>o(t.character.uuid),children:`ジョブを登録してください`})}):(0,w.jsx)(ie,{usedJobs:t.usedJobs,matchRecords:t.recentMatches,onAddWin:c?(e,n)=>c(t.character.uuid,e,n):void 0,onAddLoss:u?(e,n)=>u(t.character.uuid,e,n):void 0,onRevertLast:d?(e,n)=>d(t.character.uuid,e,n):void 0})})})]})},ve=({isOpen:e,character:t,onClose:n,onConfirm:r})=>(0,w.jsxs)(_,{isOpen:e,onClose:n,onConfirm:r,title:`キャラクターを削除`,confirmText:`削除する`,confirmType:`danger`,cancelText:`キャンセル`,children:[(0,w.jsxs)(`p`,{children:[`キャラクター「`,(0,w.jsx)(`strong`,{children:t?.name}),`」を削除しますか？`]}),(0,w.jsx)(`p`,{style:{color:`#dc2626`,marginTop:`12px`,fontSize:`0.875rem`},children:`⚠️ 関連する戦績記録もすべて削除されます。この操作は取り消せません。`})]});var ye=r.div`
  display: flex;
  flex-direction: column;
  gap: ${({theme:e})=>e.spacing[4]};
...
`,Se=()=>{let e=i(),{histories:n,isLoading:r,getSortedHistories:a,addUsedJob:o}=y(),{createCharacter:s,updateCharacter:l,deleteCharacter:u,createMatchRecord:d,deleteMatchRecord:p,getCharacterStatsForSeason:m,matchRecords:_,error:x,clearError:S}=g(),T=a()[0],E=T?m(T.uuid):[],[D,te]=(0,C.useState)(()=>E.length>0?new Set([E[0].character.uuid]):new Set),[O,k]=(0,C.useState)(null),[A,j]=(0,C.useState)(``),[M,N]=(0,C.useState)(!1),[P,F]=(0,C.useState)(null),[I,L]=(0,C.useState)(!1),[R,z]=(0,C.useState)(null),B=()=>{e.navigate({to:`/new`})},V=e=>{try{s({name:e})}catch{}},H=e=>{let t=new Set(D);t.has(e)?t.delete(e):t.add(e),te(t)},U=(e,t)=>{k(e),j(t)},W=()=>{k(null),j(``)},G=()=>{if(!(!O||!A.trim()))try{l(O,A.trim())&&(k(null),j(``))}catch{}},K=(e,t)=>{F({uuid:e,name:t}),N(!0)},q=()=>{if(P)try{u(P.uuid),N(!1),F(null)}catch{}},J=()=>{N(!1),F(null)},Y=e=>{z(e),L(!0)},X=()=>{L(!1),z(null)},Z=e=>{if(!(!T||!R))try{o({characterUuid:R,seasonUuid:T.uuid,job:e}),L(!1),z(null)}catch{}},Q=(e,t,n)=>{if(T)try{d({characterUuid:e,seasonUuid:T.uuid,job:t,map:n,isWin:!0})}catch{}},re=(e,t,n)=>{if(T)try{d({characterUuid:e,seasonUuid:T.uuid,job:t,map:n,isWin:!1})}catch{}},ie=(e,t,n)=>{if(T)try{let r=_.filter(r=>r.characterUuid===e&&r.seasonUuid===T.uuid&&r.job===t&&r.map===n);if(r.length===0)return;let i=r.reduce((e,t)=>new Date(t.createdAt)>new Date(e.createdAt)?t:e);p(i.uuid)}catch{}};return r?(0,w.jsxs)(b,{children:[(0,w.jsx)(v,{children:`現シーズンの戦績`}),(0,w.jsx)(h,{children:`読み込み中...`})]}):n.length===0?(0,w.jsxs)(b,{children:[(0,w.jsx)(f,{children:(0,w.jsx)(v,{children:`現シーズンの戦績`})}),(0,w.jsx)(h,{children:`クリスタルコンフリクト戦績管理へようこそ！`}),(0,w.jsx)(ee,{onCreateSeason:B})]}):(0,w.jsxs)(b,{children:[(0,w.jsxs)(f,{children:[(0,w.jsxs)(v,{children:[T?.seasonName,` の戦績`]}),(0,w.jsx)(t,{variant:`outline`,size:`sm`,onClick:B,children:`新しいシーズンを作成`})]}),(0,w.jsx)(h,{children:`戦績と統計情報を入力します。`}),x&&(0,w.jsxs)(be,{children:[(0,w.jsx)(`span`,{children:x}),(0,w.jsx)(xe,{onClick:S,children:`閉じる`})]}),(0,w.jsxs)(ye,{children:[E.map(e=>(0,w.jsx)(_e,{stats:e,isOpen:D.has(e.character.uuid),onToggle:()=>H(e.character.uuid),onStartEdit:U,onDelete:K,onOpenJobRegistration:Y,onAddWin:Q,onAddLoss:re,onRevertLast:ie,isEditing:O===e.character.uuid,editingName:A,onEditingNameChange:j,onSaveEdit:G,onCancelEdit:W},e.character.uuid)),(0,w.jsx)(ne,{isOpen:E.length===0,onCreateCharacter:V})]}),(0,w.jsx)(ve,{isOpen:M,character:P,onClose:J,onConfirm:q}),T&&R&&(0,w.jsx)(c,{isOpen:I,onClose:X,onRegister:Z,characterUuid:R,historyUuid:T.uuid})]})};export{Se as component};