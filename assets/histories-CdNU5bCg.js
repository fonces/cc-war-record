import{$ as e,D as t,E as n,O as r,Q as i,Z as a,a as o,d as s,i as c,m as l,n as u,ot as d,r as f,s as p,st as m,tt as h,u as g,ut as _,w as v,x as y}from"./index-MzI5li_m.js";import{n as b,r as x,t as S}from"./stores-DOPs_5ki.js";var C=_(m()),w=_(h()),T=r.div`
  overflow-x: auto;
...
`,ae=r(j)`
  ...
  color: ${({theme:e})=>e.colors.textSecondary};
  font-style: italic;
`;const oe=({histories:e,isLoading:n=!1,onDelete:r})=>{let{t:i}=s(),o=a(),[c,l]=(0,C.useState)(!1),[u,d]=(0,C.useState)(null),f=e=>{o({to:`/histories/${e}`})},m=(e,t)=>{d({uuid:e,seasonName:t}),l(!0)},h=()=>{l(!1),d(null)};return n?(0,w.jsx)(T,{children:(0,w.jsxs)(E,{children:[(0,w.jsx)(D,{children:(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.season`)}),(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.date`)}),(0,w.jsx)(O,{children:i(`pages.histories.detail`)})]})}),(0,w.jsx)(k,{children:(0,w.jsx)(ie,{children:(0,w.jsx)(ae,{colSpan:3,children:i(`common.loading`)})})})]})}):e.length===0?(0,w.jsxs)(ee,{children:[(0,w.jsx)(te,{children:(0,w.jsx)(v,{name:`history`,size:24})}),(0,w.jsx)(ne,{children:i(`pages.histories.emptyState`)}),(0,w.jsx)(re,{children:i(`pages.histories.createFirstSeason`)})]}):(0,w.jsxs)(T,{children:[(0,w.jsxs)(E,{children:[(0,w.jsx)(D,{children:(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.season`)}),(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.date`)}),(0,w.jsx)(O,{children:i(`match.actions`)})]})}),(0,w.jsx)(k,{children:e.map(t=>{let n=t.uuid===e[0]?.uuid;return(0,w.jsxs)(A,{children:[(0,w.jsx)(M,{children:t.seasonName}),(0,w.jsx)(N,{children:x(t.createdAt)}),(0,w.jsx)(j,{children:(0,w.jsxs)(I,{children:[(0,w.jsx)(P,{variant:`outline`,icon:(0,w.jsx)(v,{name:`detail`,size:16}),onClick:()=>f(n?`current`:t.uuid),title:i(`pages.histories.detail`)}),(0,w.jsx)(F,{variant:`outline`,icon:(0,w.jsx)(v,{name:`delete`,size:16}),onClick:()=>m(t.uuid,t.seasonName),title:i(`pages.histories.delete`),disabled:n})]})})]},t.uuid)})})]}),(0,w.jsx)(p,{isOpen:c,onClose:h,title:i(`pages.histories.confirmDelete`),children:(0,w.jsxs)(L,{children:[(0,w.jsx)(R,{children:i(`pages.histories.deleteDescription`,{seasonName:u?.seasonName})}),(0,w.jsxs)(z,{children:[(0,w.jsx)(t,{variant:`outline`,onClick:h,children:i(`common.cancel`)}),(0,w.jsx)(t,{variant:`primary`,onClick:()=>{u&&(r(u.uuid),l(!1),d(null))},children:i(`character.confirmDelete`)})]})]})})]})};var se=r.div`
  display: flex;
...
`,Pe=r.div`
  ...
  display: flex;
  justify-content: space-between;
`;const $=()=>{let{t:e}=s(),{id:n}=i({from:`/histories/$id`}),r=a(),{getHistoryByUuid:d,getMatchRecordsForSeason:m,histories:h}=S(),{deleteMatchRecord:_}=b(),T=(0,C.useRef)(null),[E,D]=(0,C.useState)(!1),[O,k]=(0,C.useState)(null),A=n===`current`,j=(0,C.useMemo)(()=>h[0],[h]),M=(0,C.useMemo)(()=>A?j:d(n),[A,j,n,d]);g(M?e(`pages.historyDetail.title`,{seasonName:M.seasonName}):e(`pages.historyDetail.title`,{seasonName:``}));let N=(0,C.useMemo)(()=>{if(A){let{matchRecords:e}=b.getState();return e}return m(n)},[A,n,m]),P=(0,C.useMemo)(()=>{if(!M)return[];let e=[];return N.forEach(t=>{let n=`不明`;if(A){let{characters:e}=b.getState();n=e.find(e=>e.uuid===t.characterUuid)?.name||`不明`}else n=M.characterStats.find(e=>e.character.uuid===t.characterUuid)?.character.name||`不明`;e.push({...t,characterName:n})}),A||M.characterStats.forEach(t=>{t.recentMatches.forEach(n=>{e.some(e=>e.uuid===n.uuid)||e.push({...n,characterName:t.character.name})})}),e.sort((e,t)=>new Date(t.recordedAt).getTime()-new Date(e.recordedAt).getTime())},[M,N,A]),F=xe({count:P.length,getScrollElement:()=>T.current,estimateSize:()=>56,overscan:5}),I=(e,t,n)=>{k({uuid:e,characterName:t,date:n}),D(!0)};return M?(0,w.jsxs)(u,{children:[(0,w.jsx)(o,{children:(0,w.jsx)(c,{children:M.seasonName})}),(0,w.jsxs)(f,{children:[e(`pages.historyDetail.totalMatches`,{count:P.length}),` / `,e(`pages.historyDetail.createdDate`),`: `,new Date(M.createdAt).toLocaleDateString(`ja-JP`)]}),(0,w.jsx)(Se,{children:(0,w.jsxs)(Ce,{children:[(0,w.jsxs)(we,{children:[(0,w.jsx)(Z,{children:e(`pages.historyDetail.columns.character`)}),(0,w.jsx)(Z,{width:`120px`,children:e(`pages.historyDetail.columns.job`)}),(0,w.jsx)(Z,{width:`180px`,children:e(`pages.historyDetail.columns.date`)}),(0,w.jsx)(Z,{width:`100px`,children:e(`pages.historyDetail.columns.result`)}),A&&(0,w.jsx)(Z,{width:`80px`,children:e(`match.actions`)})]}),P.length>0?(0,w.jsx)(Te,{ref:T,children:(0,w.jsx)(`div`,{style:{height:`${F.getTotalSize()}px`,position:`relative`},children:F.getVirtualItems().map(t=>{let n=P[t.index];return(0,w.jsxs)(Ee,{style:{transform:`translateY(${t.start}px)`,height:`${t.size}px`},children:[(0,w.jsx)(De,{children:n.characterName}),(0,w.jsxs)(ke,{width:`120px`,children:[(0,w.jsx)(l,{job:n.job,size:24}),(0,w.jsx)(Ae,{children:y[n.job].shortName})]}),(0,w.jsx)(Oe,{width:`180px`,children:x(n.recordedAt)}),(0,w.jsx)(Q,{width:`100px`,children:(0,w.jsx)(je,{$isWin:n.isWin,children:n.isWin?e(`pages.historyDetail.results.win`):e(`pages.historyDetail.results.defeat`)})}),A&&(0,w.jsx)(Q,{width:`80px`,children:(0,w.jsx)(Me,{variant:`outline`,icon:(0,w.jsx)(v,{name:`delete`,size:16}),onClick:()=>I(n.uuid,n.characterName,x(n.recordedAt)),title:e(`match.deleteMatch`)})})]},n.uuid)})})}):(0,w.jsx)(Ne,{children:e(`pages.historyDetail.emptyState`)})]})}),(0,w.jsx)(Pe,{children:(0,w.jsxs)(t,{variant:`outline`,size:`sm`,onClick:()=>r({to:`/histories`}),children:[(0,w.jsx)(v,{name:`back`,size:16}),e(`pages.historyDetail.backToList`)]})}),A&&(0,w.jsx)(p,{isOpen:E,title:e(`match.confirmDelete`),confirmText:e(`match.confirmDeleteButton`),confirmType:`danger`,onClose:()=>{D(!1),k(null)},onConfirm:()=>{O&&A&&(_(O.uuid),D(!1),k(null))},children:e(`match.deleteConfirmation`,{characterName:O?.characterName,date:O?.date})})]}):(0,w.jsx)(u,{children:(0,w.jsx)(c,{children:e(`pages.historyDetail.notFound`)})})};var Fe=r.div`
  max-width: 600px;
  margin: 0 auto;
  padding: ${({theme:e})=>e.spacing[6]};
`,Ie=r.div`
...
`,Ve=r.div`
  ...
  margin-bottom: ${({theme:e})=>e.spacing[4]};
  font-size: 0.875rem;
`;const He=()=>{let{t:r}=s();g(r(`pages.newSeason.title`));let i=e(),{createHistory:a,error:o,clearError:l,getSortedHistories:u}=S(),[d,m]=(0,C.useState)(``),[h,_]=(0,C.useState)(!1),[v,y]=(0,C.useState)(``),[b,x]=(0,C.useState)(``),[T,E]=(0,C.useState)(!1),D=async e=>{e.preventDefault();let t=d.trim();if(!t){y(r(`pages.newSeason.validationRequired`));return}if(t.length>50){y(r(`pages.newSeason.validationMaxLength`));return}if(y(``),u().length>0){E(!0);return}await O()},O=async()=>{_(!0),l();try{let e=d.trim(),t=a({seasonName:e});x(r(`pages.newSeason.successMessage`,{seasonName:t.seasonName})),setTimeout(()=>{i.navigate({to:`/`})},1500)}catch(e){console.error(`シーズン作成エラー:`,e)}finally{_(!1),E(!1)}},k=()=>{O()},A=()=>{E(!1)},j=()=>{history.back()},M=e=>{m(e.target.value),v&&y(``)},N=u()[0]?.seasonName||``;return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(p,{isOpen:T,onClose:A,title:r(`pages.newSeason.confirmTitle`),confirmText:r(`pages.newSeason.create`),cancelText:r(`pages.newSeason.cancel`),onConfirm:k,confirmType:`danger`,isLoading:h,children:r(`pages.newSeason.confirmDescription`,{seasonName:N})}),(0,w.jsxs)(Fe,{children:[(0,w.jsxs)(Ie,{children:[(0,w.jsx)(c,{children:r(`pages.newSeason.title`)}),(0,w.jsx)(f,{children:r(`pages.newSeason.description`)})]}),(0,w.jsxs)(Le,{onSubmit:D,children:[(o||v)&&(0,w.jsx)(Be,{children:v||o}),b&&(0,w.jsx)(Ve,{children:b}),(0,w.jsx)(Re,{children:(0,w.jsx)(n,{label:r(`pages.newSeason.seasonName`),type:`text`,value:d,onChange:M,placeholder:r(`pages.newSeason.seasonNamePlaceholder`),disabled:h||!!b,fullWidth:!0,required:!0})}),(0,w.jsxs)(ze,{children:[(0,w.jsx)(t,{type:`button`,variant:`outline`,onClick:j,disabled:h||!!b,children:r(`pages.newSeason.cancel`)}),(0,w.jsx)(t,{type:`submit`,disabled:h||!!b||!d.trim(),children:r(h?`pages.newSeason.creating`:`pages.newSeason.create`)})]})]})]})]})};export{$ as n,U as r,He as t};