const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/new-C06fdsS8.js","assets/react-vendor-D1pS86Oe.js","assets/rolldown-runtime-CIDIeb-o.js","assets/graphs-BRy3CI2M.js","assets/faq-CSbYZmEz.js","assets/routes-CausFUr3.js","assets/histories-CZRvrr2c.js","assets/_id-BygvOl4k.js"])))=>i.map(i=>d[i]);
...
`,Ye=_.div`
  ...
  animation: ${We} 0.2s cubic-bezier(0.4, 0, 0.2, 1);
...
`,Qe=_.select`
  ...
  width: 0;
  height: 0;
`;const $e=(0,y.memo)(({id:e,label:t,error:n,fullWidth:r,width:i,options:a,value:o,onChange:s,disabled:c})=>{let[l,u]=(0,y.useState)(!1),d=(0,y.useRef)(null);(0,y.useEffect)(()=>{let e=e=>{d.current&&!d.current.contains(e.target)&&u(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let f=e=>{c||(u(!1),s&&s({target:{value:e}}))},p=a.find(e=>e.value===o)?.label||a[0]?.label||``;return(0,v.jsxs)(Ge,{ref:d,fullWidth:r,width:i,children:[t&&(0,v.jsx)(Ke,{htmlFor:e,children:t}),(0,v.jsxs)(qe,{type:`button`,onClick:()=>!c&&u(!l),isOpen:l,hasError:!!n,disabled:c,children:[p,(0,v.jsx)(Je,{isOpen:l,children:(0,v.jsx)(T,{name:`arrowDropDown`,size:24})})]}),(0,v.jsx)(Ye,{isOpen:l,children:a.map(e=>(0,v.jsx)(Xe,{onClick:()=>f(e.value),isSelected:e.value===o,children:e.label},e.value))}),(0,v.jsx)(Qe,{id:e,value:o,onChange:s,disabled:c,tabIndex:-1,children:a.map(e=>(0,v.jsx)(`option`,{value:e.value,children:e.label},e.value))}),n&&(0,v.jsx)(Ze,{children:n})]})});$e.displayName=`Select`;const et=(e,t,n=600)=>e>=51?t.colors.success[n]:e>=40?t.colors.warning[n]:t.colors.error[n],tt=()=>new Date().toISOString(),nt=(e,t,n)=>{let r=new Date(e);if(!t){let e=r.getFullYear(),t=String(r.getMonth()+1).padStart(2,`0`),n=String(r.getDate()).padStart(2,`0`),i=String(r.getHours()).padStart(2,`0`),a=String(r.getMinutes()).padStart(2,`0`);return`${e}-${t}-${n} ${i}:${a}`}return r.toLocaleDateString(t,n)},rt=(e,t)=>new Date(e).toLocaleDateString(t,{month:`numeric`,day:`numeric`}),it=(e,t)=>new Date(e).toLocaleDateString(t,{year:`numeric`,month:`long`,day:`numeric`}),E=e=>e.length,D=e=>e.filter(e=>e.isWin).length,at=e=>e.filter(e=>!e.isWin).length,ot=e=>{let t=E(e);if(t===0)return 0;let n=D(e);return Math.round(n/t*100)},O={TANK:`tank`,HEALER:`healer`,MELEE_DPS:`melee_dps`,PHYSICAL_RANGED_DPS:`physical_ranged_dps`,MAGICAL_RANGED_DPS:`magical_ranged_dps`},k={[O.TANK]:{code:O.TANK,name:`タンク`,nameEn:`Tank`,color:`#3b82f6`},[O.HEALER]:{code:O.HEALER,name:`ヒーラー`,nameEn:`Healer`,color:`#10b981`},[O.MELEE_DPS]:{code:O.MELEE_DPS,name:`近接DPS`,nameEn:`MeleeDPS`,color:`#f59e0b`},[O.PHYSICAL_RANGED_DPS]:{code:O.PHYSICAL_RANGED_DPS,name:`物理遠隔DPS`,nameEn:`PhysicalRangedDPS`,color:`#8b5cf6`},[O.MAGICAL_RANGED_DPS]:{code:O.MAGICAL_RANGED_DPS,name:`魔法遠隔DPS`,nameEn:`MagicalRangedDPS`,color:`#ef4444`}},A={PALADIN:`PLD`,WARRIOR:`WAR`,DARK_KNIGHT:`DRK`,GUNBREAKER:`GNB`,WHITE_MAGE:`WHM`,SCHOLAR:`SCH`,ASTROLOGIAN:`AST`,SAGE:`SGE`,MONK:`MNK`,DRAGOON:`DRG`,NINJA:`NIN`,SAMURAI:`SAM`,REAPER:`RPR`,VIPER:`VPR`,BARD:`BRD`,MACHINIST:`MCH`,DANCER:`DNC`,BLACK_MAGE:`BLM`,SUMMONER:`SMN`,RED_MAGE:`RDM`,PICTOMANCER:`PCT`},j={[A.PALADIN]:{code:A.PALADIN,name:`ナイト`,nameEn:`Paladin`,shortName:`PLD`,role:O.TANK,iconId:19,color:`#5EADDC`},[A.WARRIOR]:{code:A.WARRIOR,name:`戦士`,nameEn:`Warrior`,shortName:`WAR`,role:O.TANK,iconId:21,color:`#CF2621`},[A.DARK_KNIGHT]:{code:A.DARK_KNIGHT,name:`暗黒騎士`,nameEn:`DarkKnight`,shortName:`DRK`,role:O.TANK,iconId:32,color:`#D126CC`},[A.GUNBREAKER]:{code:A.GUNBREAKER,name:`ガンブレイカー`,nameEn:`Gunbreaker`,shortName:`GNB`,role:O.TANK,iconId:37,color:`#9C8542`},[A.WHITE_MAGE]:{code:A.WHITE_MAGE,name:`白魔道士`,nameEn:`WhiteMage`,shortName:`WHM`,role:O.HEALER,iconId:24,color:`#E6D8BC`},[A.SCHOLAR]:{code:A.SCHOLAR,name:`学者`,nameEn:`Scholar`,shortName:`SCH`,role:O.HEALER,iconId:28,color:`#8657FF`},[A.ASTROLOGIAN]:{code:A.ASTROLOGIAN,name:`占星術師`,nameEn:`Astrologian`,shortName:`AST`,role:O.HEALER,iconId:33,color:`#E6C84A`},[A.SAGE]:{code:A.SAGE,name:`賢者`,nameEn:`Sage`,shortName:`SGE`,role:O.HEALER,iconId:40,color:`#8FD14F`},[A.MONK]:{code:A.MONK,name:`モンク`,nameEn:`Monk`,shortName:`MNK`,role:O.MELEE_DPS,iconId:20,color:`#D69C00`},[A.DRAGOON]:{code:A.DRAGOON,name:`竜騎士`,nameEn:`Dragoon`,shortName:`DRG`,role:O.MELEE_DPS,iconId:22,color:`#4164CD`},[A.NINJA]:{code:A.NINJA,name:`忍者`,nameEn:`Ninja`,shortName:`NIN`,role:O.MELEE_DPS,iconId:30,color:`#AF1964`},[A.SAMURAI]:{code:A.SAMURAI,name:`侍`,nameEn:`Samurai`,shortName:`SAM`,role:O.MELEE_DPS,iconId:34,color:`#E46D04`},[A.REAPER]:{code:A.REAPER,name:`リーパー`,nameEn:`Reaper`,shortName:`RPR`,role:O.MELEE_DPS,iconId:39,color:`#965A90`},[A.VIPER]:{code:A.VIPER,name:`ヴァイパー`,nameEn:`Viper`,shortName:`VPR`,role:O.MELEE_DPS,iconId:41,color:`#B07830`},[A.BARD]:{code:A.BARD,name:`吟遊詩人`,nameEn:`Bard`,shortName:`BRD`,role:O.PHYSICAL_RANGED_DPS,iconId:23,color:`#91BA5E`},[A.MACHINIST]:{code:A.MACHINIST,name:`機工士`,nameEn:`Machinist`,shortName:`MCH`,role:O.PHYSICAL_RANGED_DPS,iconId:31,color:`#6EE1D6`},[A.DANCER]:{code:A.DANCER,name:`踊り子`,nameEn:`Dancer`,shortName:`DNC`,role:O.PHYSICAL_RANGED_DPS,iconId:38,color:`#D98B8A`},[A.BLACK_MAGE]:{code:A.BLACK_MAGE,name:`黒魔道士`,nameEn:`BlackMage`,shortName:`BLM`,role:O.MAGICAL_RANGED_DPS,iconId:25,color:`#A579D6`},[A.SUMMONER]:{code:A.SUMMONER,name:`召喚士`,nameEn:`Summoner`,shortName:`SMN`,role:O.MAGICAL_RANGED_DPS,iconId:27,color:`#2D9B78`},[A.RED_MAGE]:{code:A.RED_MAGE,name:`赤魔道士`,nameEn:`RedMage`,shortName:`RDM`,role:O.MAGICAL_RANGED_DPS,iconId:35,color:`#E87B7B`},[A.PICTOMANCER]:{code:A.PICTOMANCER,name:`ピクトマンサー`,nameEn:`Pictomancer`,shortName:`PCT`,role:O.MAGICAL_RANGED_DPS,iconId:42,color:`#D4C05C`}},M=e=>j[e],st=e=>{let t=M(e);if(!t)return``;let n=``;switch(t.role){case O.TANK:n=`01_TANK`;break;case O.HEALER:n=`02_HEALER`;break;case O.MELEE_DPS:case O.PHYSICAL_RANGED_DPS:case O.MAGICAL_RANGED_DPS:n=`03_DPS`;break}return`/cc-war-record/img/${n}/Job/${t.nameEn}.png`},ct=e=>{let t=``;switch(e){case O.TANK:t=`TankRole`;break;case O.HEALER:t=`HealerRole`;break;case O.MELEE_DPS:t=`MeleeDPS`;break;case O.PHYSICAL_RANGED_DPS:t=`PhysicalRangedDPS`;break;case O.MAGICAL_RANGED_DPS:t=`MagicalRangedDPS`;break}return`/cc-war-record/img/00_ROLE/${t}.png`};O.TANK,O.HEALER,O.MELEE_DPS,O.PHYSICAL_RANGED_DPS,O.MAGICAL_RANGED_DPS,O.TANK,O.HEALER,O.MELEE_DPS,O.PHYSICAL_RANGED_DPS,O.MAGICAL_RANGED_DPS;const lt=e=>{let t=Object.values(A);return e.sort((e,n)=>t.indexOf(e)-t.indexOf(n))},N={BUILD_TIMESTAMP:`app-build-timestamp`,THEME:`cc-war-record-theme`,CHARACTERS:`cc-war-record-characters`,MATCH_RECORDS:`cc-war-record-match-records`,HISTORIES:`cc-war-record-histories`,HISTORY:"histories-${uuid}",RADAR_CHART_JOBS:`cc-war-record:radar-chart-jobs`},P=(e,t)=>{try{if(typeof window>`u`)return t;let n=window.localStorage.getItem(e);return n===null?t:JSON.parse(n)}catch(n){return console.error(`Error reading from localStorage (key: ${e}):`,n),t}},F=(e,t)=>{try{if(typeof window>`u`)return;window.localStorage.setItem(e,JSON.stringify(t))}catch(t){console.error(`Error writing to localStorage (key: ${e}):`,t)}},ut=e=>{try{if(typeof window>`u`)return;window.localStorage.removeItem(e)}catch(t){console.error(`Error removing from localStorage (key: ${e}):`,t)}},I={THE_PALAISTRA:`THE_PALAISTRA`,VOLCANIC_HEART:`VOLCANIC_HEART`,CLOUD_NINE:`CLOUD_NINE`,TOUHOU_KARAKURI_GOTEN:`TOUHOU_KARAKURI_GOTEN`,RED_SANDS:`RED_SANDS`,BAYSIDE_BATTLEGROUND:`BAYSIDE_BATTLEGROUND`},L={ARENA:`arena`,SKY:`sky`,VOLCANIC:`volcanic`,WATER:`water`,CASTLE:`castle`,URBAN:`urban`,DESERT:`desert`},R={SMALL:`small`,MEDIUM:`medium`,LARGE:`large`},z={CENTRAL_CRYSTAL:`central_crystal`,MULTI_LEVEL:`multi_level`,NARROW_PATHS:`narrow_paths`,OPEN_AREA:`open_area`,ENVIRONMENTAL_HAZARDS:`environmental_hazards`,VERTICAL_MOVEMENT:`vertical_movement`};I.THE_PALAISTRA,I.THE_PALAISTRA,L.ARENA,R.MEDIUM,z.CENTRAL_CRYSTAL,z.OPEN_AREA,I.VOLCANIC_HEART,I.VOLCANIC_HEART,L.VOLCANIC,R.MEDIUM,z.ENVIRONMENTAL_HAZARDS,z.CENTRAL_CRYSTAL,I.CLOUD_NINE,I.CLOUD_NINE,L.SKY,R.LARGE,z.MULTI_LEVEL,z.VERTICAL_MOVEMENT,I.TOUHOU_KARAKURI_GOTEN,I.TOUHOU_KARAKURI_GOTEN,L.CASTLE,R.MEDIUM,z.MULTI_LEVEL,z.NARROW_PATHS,z.ENVIRONMENTAL_HAZARDS,I.RED_SANDS,I.RED_SANDS,L.DESERT,R.LARGE,z.OPEN_AREA,z.ENVIRONMENTAL_HAZARDS,I.BAYSIDE_BATTLEGROUND,I.BAYSIDE_BATTLEGROUND,L.WATER,R.LARGE,z.OPEN_AREA,z.CENTRAL_CRYSTAL,z.ENVIRONMENTAL_HAZARDS;const dt=(e,t)=>t(`maps.${e}`);var B=[I.THE_PALAISTRA,I.VOLCANIC_HEART,I.TOUHOU_KARAKURI_GOTEN,I.BAYSIDE_BATTLEGROUND,I.CLOUD_NINE,I.RED_SANDS],V=new Date(`2022-01-01T00:00:00+09:00`),H=5400*1e3;const U=(e=new Date)=>{let t=e.getTime()-V.getTime(),n=Math.floor(t/H)%B.length;return B[n]},W=(e=new Date)=>{let t=e.getTime()-V.getTime(),n=(Math.floor(t/H)%B.length+1)%B.length;return B[n]},ft=(e=new Date)=>{let t=(e.getTime()-V.getTime())%H,n=H-t;return new Date(e.getTime()+n)},pt=()=>`xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx`.replace(/[xy]/g,e=>{let t=Math.random()*16|0;return(e===`x`?t:t&3|8).toString(16)}),mt=()=>{if(typeof window>`u`)return 0;let e=document.createElement(`div`);e.style.visibility=`hidden`,e.style.overflow=`scroll`,e.style.width=`100px`,e.style.position=`absolute`,e.style.top=`-9999px`,document.body.appendChild(e);let t=document.createElement(`div`);t.style.width=`100%`,e.appendChild(t);let n=e.offsetWidth-t.offsetWidth;return document.body.removeChild(e),n};var G=e(se()),ht=[N.CHARACTERS,N.MATCH_RECORDS,N.HISTORIES,N.RADAR_CHART_JOBS];const gt=async()=>{let e=new G.default;ht.forEach(t=>{let n=localStorage.getItem(t);if(n){let r=`${t.replace(/^cc-war-record[-:]?/,``)}.json`;e.file(r,n)}});let t=[];for(let e=0;e<localStorage.length;e++){let n=localStorage.key(e);n?.startsWith(`histories-`)&&t.push(n)}t.forEach(t=>{let n=localStorage.getItem(t);n&&e.file(`${t}.json`,n)});let n=await e.generateAsync({type:`blob`}),r=`cc-war-record-backup-${new Date().toISOString().replace(/[-:]/g,``).replace(/\.\d{3}Z$/,``).replace(`T`,`-`)}.zip`,i=URL.createObjectURL(n),a=document.createElement(`a`);a.href=i,a.download=r,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)},_t=async e=>{let t=await new G.default().loadAsync(e),n=new Set,r=[`characters`,`match-records`,`histories`,`radar-chart-jobs`],i=new Map,a=[];t.forEach((e,t)=>{if(t.dir)return;let o=e.replace(/\.json$/,``);if(!(o.startsWith(`histories-`)||r.some(e=>o===e)))throw Error(`BACKUP_FILE_CORRUPTED`);n.add(o),a.push((async()=>{let e=await t.async(`text`);try{JSON.parse(e)}catch{throw Error(`BACKUP_FILE_CORRUPTED`)}let n;n=o.startsWith(`histories-`)?o:o.includes(`:`)?`cc-war-record:${o}`:`cc-war-record-${o}`,i.set(n,localStorage.getItem(n)),localStorage.setItem(n,e)})())});try{await Promise.all(a)}catch(e){throw i.forEach((e,t)=>{e===null?localStorage.removeItem(t):localStorage.setItem(t,e)}),e}};var vt=_.img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  object-fit: contain;
  display: inline-block;
...
`;const K=(0,y.memo)(({job:e,size:t=32,alt:n,className:r})=>{let i=st(e),a=e,o=e=>{let t=M(e);return t?t.color:`#6B7280`};return i?(0,v.jsx)(vt,{src:i,alt:n||e,size:t,className:r,onError:i=>{let s=i.target;s.style.display=`none`;let c=document.createElement(`div`);c.className=r||``,c.style.cssText=`
          width: ${t}px;
          height: ${t}px;
        ...
        `,c.textContent=a,c.title=n||e,s.parentNode&&s.parentNode.insertBefore(c,s)}}):(0,v.jsx)(yt,{size:t,bgColor:o(e),className:r,title:n||e,children:a})});K.displayName=`JobIcon`;var bt=_.img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  object-fit: contain;
  display: inline-block;
`,xt=_.div`
  ...
  font-weight: bold;
  font-size: ${({size:e})=>Math.max(e*.3,10)}px;
`;const q=(0,y.memo)(({role:e,size:t=32,alt:n,className:r})=>{let i=ct(e),a=k[e]?.name||e,o=e=>{let t=k[e];return t?t.color:`#6B7280`};return i?(0,v.jsx)(bt,{src:i,alt:n||a,size:t,className:r,onError:i=>{let s=i.target;s.style.display=`none`;let c=document.createElement(`div`);c.className=r||``,c.style.cssText=`
          width: ${t}px;
          height: ${t}px;
          background-color: ${o(e)};
          border-radius: 2px;
...
`,It=_.div`
  ...
  display: flex;
  flex-direction: column;
  animation: ${Pt} ${({theme:e})=>e.transitions.bounce};
`,Lt=_.div`
...
`;const Ut=(0,y.memo)(({isOpen:e,onClose:t,title:n,children:r,confirmText:i,cancelText:a,onConfirm:o,confirmType:s=`primary`,isLoading:c=!1})=>{let{t:l}=J(),u=i??l(`common.confirm`),d=a??l(`common.cancel`);return wt(e),e?(0,v.jsx)(Ft,{isOpen:e,onClick:e=>{e.target===e.currentTarget&&t()},onKeyDown:e=>{e.key===`Escape`&&t()},children:(0,v.jsxs)(It,{role:`dialog`,"aria-modal":`true`,"aria-labelledby":`dialog-title`,children:[(0,v.jsxs)(Lt,{children:[(0,v.jsx)(Rt,{id:`dialog-title`,children:n}),(0,v.jsx)(zt,{onClick:t,"aria-label":l(`common.closeDialog`),children:(0,v.jsx)(T,{name:`close`,size:20})})]}),(0,v.jsx)(Bt,{children:r}),o&&(0,v.jsxs)(Vt,{children:[(0,v.jsx)(S,{variant:`secondary`,onClick:t,disabled:c,children:d}),(0,v.jsx)(Ht,{confirmType:s,onClick:o,disabled:c,children:c?l(`common.processing`):u})]})]})}):null});Ut.displayName=`Dialog`;var Wt=_.input`
  appearance: none;
  width: 1rem;
  height: 1rem;
...
`;const Gt=(0,y.memo)(({checked:e,onChange:t,disabled:n=!1})=>(0,v.jsx)(Wt,{type:`checkbox`,checked:e,onChange:t,disabled:n}));Gt.displayName=`Checkbox`;var Kt=h`
  from {
    opacity: 0;
    transform: translateY(-8px);
  }
...
`,Zt=_.div`
  ...
  z-index: 50;
  display: ${({isOpen:e})=>e?`block`:`none`};
  animation: ${Kt} 0.2s cubic-bezier(0.4, 0, 0.2, 1);
...
`,en=_.span`
  ...
  font-size: 0.75rem;
  font-weight: 600;
`;const tn=(0,y.memo)(({label:e,value:t,onChange:n,options:r,placeholder:i=`選択してください`,maxSelections:a,width:o,fullWidth:s})=>{let[c,l]=(0,y.useState)(!1),u=(0,y.useRef)(null);(0,y.useEffect)(()=>{let e=e=>{u.current&&!u.current.contains(e.target)&&l(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let d=e=>{if(t.includes(e))n(t.filter(t=>t!==e));else{if(a&&t.length>=a)return;n([...t,e])}};return(0,v.jsxs)(qt,{ref:u,width:o,fullWidth:s,children:[e&&(0,v.jsx)(Jt,{children:e}),(0,v.jsxs)(Yt,{type:`button`,onClick:()=>l(!c),isOpen:c,children:[(()=>t.length===0?i:t.map(e=>r.find(t=>t.value===e)?.label||e).join(`, `))(),t.length>0&&(0,v.jsxs)(en,{children:[` (`,t.length,`)`]}),(0,v.jsx)(Xt,{isOpen:c,children:(0,v.jsx)(T,{name:`add`,size:16})})]}),(0,v.jsx)(Zt,{isOpen:c,children:r.map(e=>{let n=a?t.length>=a&&!t.includes(e.value):!1;return(0,v.jsxs)(Qt,{disabled:n,children:[(0,v.jsx)(Gt,{checked:t.includes(e.value),onChange:()=>d(e.value),disabled:n}),(0,v.jsx)($t,{children:e.label})]},e.value)})})]})});tn.displayName=`MultiSelect`;var nn=_.div`
...
`,cn=_.div`
  ...
  gap: ${({gap:e})=>e};
  animation: ${Y} 0.5s ease-out;
`;const X=(0,y.memo)(({children:e})=>(0,v.jsx)(nn,{children:e}));X.displayName=`Page`;const ln=(0,y.memo)(({children:e})=>(0,v.jsx)(rn,{children:e}));ln.displayName=`PageTitleContainer`;const un=(0,y.memo)(({children:e})=>(0,v.jsx)(an,{children:e}));un.displayName=`PageTitle`;const dn=(0,y.memo)(({children:e})=>(0,v.jsx)(on,{children:e}));dn.displayName=`PageDescription`;const fn=(0,y.memo)(({children:e})=>(0,v.jsx)(sn,{children:e}));fn.displayName=`PageTitleActions`;const pn=(0,y.memo)(({children:e,gap:t=`1.5rem`})=>(0,v.jsx)(cn,{gap:t,children:e}));pn.displayName=`PageContainer`;var mn=h`
  from {
    opacity: 0;
    transform: translateY(8px);
  }
...
`,yn=_.div`
  ...
  z-index: 50;
  display: ${({isOpen:e})=>e?`block`:`none`};
  animation: ${({direction:e})=>e===`up`?mn:hn} 0.2s cubic-bezier(0.4, 0, 0.2, 1);
...
`,Sn=_.span`
  ...
  transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1);
`,Cn=[{code:`ja`,name:`日本語`,flag:`🇯🇵`},{code:`en`,name:`English`,flag:`🇺🇸`},{code:`ko`,name:`한국어`,flag:`🇰🇷`}];const wn=(0,y.memo)(({direction:e=`down`,fullWidth:t=!1})=>{let[n,r]=(0,y.useState)(!1),{currentLanguage:i,changeLanguage:a}=J(),o=(0,y.useRef)(null);(0,y.useEffect)(()=>{let e=e=>{o.current&&!o.current.contains(e.target)&&r(!1)};return n&&document.addEventListener(`mousedown`,e),()=>{document.removeEventListener(`mousedown`,e)}},[n]);let s=e=>{a(e),r(!1)},c=Cn.find(e=>e.code===i)?.name||`日本語`;return(0,v.jsxs)(gn,{ref:o,$fullWidth:t,children:[(0,v.jsxs)(_n,{onClick:()=>r(!n),$fullWidth:t,children:[(0,v.jsxs)(vn,{children:[(0,v.jsx)(T,{name:`language`,size:18}),(0,v.jsx)(`span`,{children:c})]}),(0,v.jsx)(Sn,{isOpen:n,children:(0,v.jsx)(T,{name:`arrowDropDown`,size:24})})]}),(0,v.jsx)(yn,{isOpen:n,direction:e,children:Cn.map(e=>(0,v.jsxs)(bn,{isActive:i===e.code,onClick:()=>s(e.code),children:[(0,v.jsx)(xn,{children:e.flag}),(0,v.jsx)(`span`,{children:e.name})]},e.code))})]})});wn.displayName=`LanguageSelector`;var Tn=_.div`
  position: fixed;
...
`,In=_.div`
  ...
  animation: ${Mt} 1.5s ease-in-out infinite;
`;function Ln({data:e,columns:t,renderRow:n,rowHeight:i=56,overscan:a=5,height:o,isLoading:s=!1,loadingText:c=`Loading...`,emptyText:l=`No data`,getRowKey:u}){let d=(0,y.useRef)(null),f=r({count:e.length,getScrollElement:()=>d.current,estimateSize:()=>i,overscan:a});return(0,v.jsx)(On,{$height:o,children:(0,v.jsxs)(kn,{children:[(0,v.jsx)(An,{children:t.map(e=>(0,v.jsx)(jn,{width:e.width,children:e.label},e.key))}),s?(0,v.jsx)(Z,{children:(0,v.jsx)(In,{children:c})}):e.length>0?(0,v.jsx)(Z,{ref:d,children:(0,v.jsx)(`div`,{style:{height:`${f.getTotalSize()}px`,position:`relative`},children:f.getVirtualItems().map(t=>{let r=e[t.index];return(0,v.jsx)(`div`,{style:{position:`absolute`,top:0,left:0,width:`100%`,transform:`translateY(${t.start}px)`,height:`${t.size}px`},children:n(r,t)},u(r))})})}):(0,v.jsx)(Pn,{children:(0,v.jsx)(Fn,{children:l})})]})})}const Rn=_.div`
  display: grid;
...
`,Vn=_.div`
  ...
  ${({theme:e,$type:t,$winRate:n})=>t===`win`?`color: ${e.colors.win[400]};`:t===`defeat`?`color: ${e.colors.defeat[400]};`:t===`winRate`&&n!==void 0?`color: ${et(n,e,400)};`:`
      background: linear-gradient(135deg, #26a1df 0%, #f36346 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      background-clip: text;
...
`;var Un={danger:g`
  ...
  ${({$type:e})=>Un[e||`default`]}
`;const Gn=(0,y.memo)(({icon:e,children:t,...n})=>(0,v.jsx)(Wn,{variant:`outline`,...n,children:e||t}));Gn.displayName=`IconicButton`;var Kn=_.div`
  padding: ${({theme:e})=>e.spacing[3]} ${({theme:e})=>e.spacing[4]};
...
`;const Yn=(0,y.memo)(({type:e=`info`,children:t,onClose:n})=>(0,v.jsxs)(Kn,{$type:e,children:[(0,v.jsx)(qn,{children:t}),n&&(0,v.jsx)(Jn,{onClick:n,type:`button`,"aria-label":`Close`,children:(0,v.jsx)(T,{name:`close`,size:16})})]}));Yn.displayName=`Flush`;var Xn=e(m()),Zn=h`
  from {
...
`,$n=_.div`
  ...
  animation: ${({$isVisible:e})=>e?Zn:Qn} 0.3s ease-out forwards;
...
`;const rr=(0,y.memo)(({open:e,message:t,actionLabel:n,onAction:r,onClose:i,autoHideDuration:a})=>{let{t:o}=J(),[s,c]=(0,y.useState)(!1);(0,y.useEffect)(()=>{if(e){let e=setTimeout(()=>{c(!0)},10);if(a){let t=setTimeout(()=>{c(!1),setTimeout(()=>{i?.()},300)},a);return()=>{clearTimeout(e),clearTimeout(t)}}return()=>clearTimeout(e)}else c(!1)},[e,a,i]);let l=()=>{c(!1),setTimeout(()=>{i?.()},300)};if(!e)return null;let u=(0,v.jsx)($n,{$isVisible:s,children:(0,v.jsxs)(er,{children:[(0,v.jsx)(tr,{children:t}),n&&r&&(0,v.jsx)(S,{variant:`outline`,size:`sm`,onClick:r,children:n}),(0,v.jsx)(nr,{onClick:l,"aria-label":o(`common.close`),children:(0,v.jsx)(w,{})})]})});return(0,Xn.createPortal)(u,document.body)});rr.displayName=`Snackbar`;var ir=_.header`
  position: sticky;
  top: 0;
  z-index: 20;
  background: ${({theme:e})=>e.gradients.glass};
...
`,lr=_.h1`
  ...
  font-weight: bold;
  color: ${({theme:e})=>e.colors.text};
`;const ur=({onMenuClick:e})=>{let{t}=J();return(0,v.jsx)(ir,{children:(0,v.jsxs)(ar,{children:[(0,v.jsxs)(sr,{children:[(0,v.jsx)(cr,{src:`/cc-war-record/img/cc.webp`,alt:`CC`}),(0,v.jsx)(lr,{children:t(`common.appName`)})]}),(0,v.jsxs)(or,{children:[(0,v.jsx)(Dn,{}),(0,v.jsx)(T,{name:`hamburger`,size:24,onClick:e})]})]})})},dr=[{labelKey:`navigation.home`,path:`/`,icon:`home`},{labelKey:`navigation.graphs`,path:`/graphs`,icon:`chart`},{labelKey:`navigation.histories`,path:`/histories`,icon:`history`},{labelKey:`navigation.faq`,path:`/faq`,icon:`detail`}];var fr=_.aside`
  position: fixed;
  left: 0;
  top: 0;
  height: 100vh;
...
`;const br=({isOpen:e,isActivePath:t,onClose:n})=>{let{t:r}=J();return(0,v.jsxs)(fr,{$isOpen:e,children:[(0,v.jsx)(yr,{children:(0,v.jsx)(T,{name:`close`,size:24,onClick:n})}),(0,v.jsxs)(pr,{children:[(0,v.jsx)(mr,{src:`/cc-war-record/img/cc.webp`,alt:`CC`}),(0,v.jsx)(hr,{children:r(`common.appName`)})]}),(0,v.jsx)(gr,{children:dr.map(e=>(0,v.jsxs)(_r,{to:e.path,$isActive:t(e.path),onClick:n,children:[(0,v.jsx)(vr,{$isActive:t(e.path),children:(0,v.jsx)(T,{name:e.icon,size:20})}),r(e.labelKey)]},e.path))}),(0,v.jsx)(`div`,{style:{marginTop:`auto`,paddingTop:`24px`},children:(0,v.jsx)(wn,{direction:`up`,fullWidth:!0})})]})};var xr=_.div`
  position: fixed;
  inset: 0;
...
`;const wr=({children:e})=>{let[t,n]=(0,y.useState)(!1),r=i(),a=()=>{n(!t)},o=()=>{n(!1)};return(0,v.jsxs)(Cr,{children:[(0,v.jsx)(ur,{onMenuClick:a}),(0,v.jsx)(br,{isOpen:t,isActivePath:e=>e===`/`?r.pathname===`/`:r.pathname.startsWith(e),onClose:o}),(0,v.jsx)(xr,{$isOpen:t,onClick:o}),(0,v.jsx)(Sr,{children:e})]})};var Tr=_.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,Ar=_.p`
  ...
  margin: 0.5rem auto;
  line-height: 1.6;
`;const jr=()=>(0,v.jsx)(X,{children:(0,v.jsxs)(Tr,{children:[(0,v.jsxs)(Er,{children:[(0,v.jsx)(Or,{children:`404`}),(0,v.jsx)(kr,{children:`ページが見つかりません`}),(0,v.jsx)(Ar,{children:`お探しのページは削除されたか、URLが間違っている可能性があります。`})]}),(0,v.jsx)(Dr,{children:(0,v.jsx)(c,{to:`/`,children:(0,v.jsx)(S,{children:`ホームに戻る`})})})]})});var Mr=h`
  0%, 100% {
    transform: translateY(0);
  }
  50% {
...
`,Fr=_.div`
  ...
  position: relative;
  z-index: 1;
  animation: ${Mr} 3s ease-in-out infinite;
...
`;const zr=(0,y.memo)(({icon:e=`home`})=>{let{t}=J(),n=s();return(0,v.jsxs)(Pr,{children:[(0,v.jsx)(Fr,{children:(0,v.jsx)(T,{name:e,size:32})}),(0,v.jsx)(Ir,{children:t(`pages.home.noSeason`)}),(0,v.jsx)(Lr,{children:t(`pages.home.createFirstSeason`)}),(0,v.jsxs)(Rr,{onClick:()=>{n({to:`/new`})},children:[(0,v.jsx)(T,{name:`add`,size:20,color:`white`}),t(`pages.home.createSeason`)]})]})});zr.displayName=`EmptyState`;var Br=_.div`
  display: flex;
  justify-content: center;
  align-items: center;
  min-height: 60vh;
...
`,Hr=_.p`
  ...
  color: ${({theme:e})=>e.colors.textSecondary};
  font-size: 0.875rem;
`;const Ur=()=>(0,v.jsx)(Br,{children:(0,v.jsxs)(`div`,{children:[(0,v.jsx)(Vr,{}),(0,v.jsx)(Hr,{children:`Loading...`})]})}),Wr=_.form`
  background: ${({theme:e})=>e.gradients.glass};
  backdrop-filter: ${({theme:e})=>e.blur.md};
  padding: ${({theme:e})=>e.spacing[8]};
  border-radius: ${({theme:e})=>e.borderRadius.lg};
...
`;var Q=e(l()),qr=`G-8MW9KTB7Q5`;const Jr=()=>{Q.default.initialize(qr,{gaOptions:{siteSpeedSampleRate:100}})},Yr=(e,t)=>{Q.default.send({hitType:`pageview`,page:e,title:t})},Xr=(e,t,n,r)=>{Q.default.event({category:e,action:t,label:n,value:r})},Zr=async()=>{try{let e=await fetch(`/cc-war-record/build-info.json`,{cache:`no-cache`});return e.ok?await e.json():(console.warn(`Failed to fetch build-info.json:`,e.status),null)}catch(e){return console.error(`Error fetching build-info.json:`,e),null}},Qr=async()=>{let e=await Zr();if(!e)return console.warn(`Failed to fetch build info`),!1;let{timestamp:t}=e,n=P(N.BUILD_TIMESTAMP,``);if(!n)return F(N.BUILD_TIMESTAMP,t.toString()),console.info(`First access: build timestamp saved`),!1;if(Number(n)!==t&&(console.info(`Build updated detected:`,{old:new Date(Number(n)).toISOString(),new:e.buildTime}),F(N.BUILD_TIMESTAMP,t.toString()),`serviceWorker`in navigator&&navigator.serviceWorker.controller))try{if(await(await navigator.serviceWorker.ready).unregister(),console.info(`ServiceWorker unregistered`),`caches`in window){let e=await caches.keys();await Promise.all(e.map(e=>caches.delete(e))),console.info(`Cache storage cleared`)}return!0}catch(e){console.error(`Error clearing ServiceWorker cache:`,e)}return!1},$=d({component:$r,notFoundComponent:ei});function $r(){let e=ne(),{t}=J(),n=(0,y.useRef)(!1),[r,i]=(0,y.useState)(!1);return(0,y.useEffect)(()=>{window.scrollTo(0,0),Yr(e.location.pathname)},[e.location.pathname]),(0,y.useEffect)(()=>{!r&&!n.current&&setTimeout(()=>{Qr().then(e=>{e&&i(!0)})},1e3)},[e.location.pathname]),(0,v.jsxs)(wr,{children:[(0,v.jsx)(y.Suspense,{fallback:(0,v.jsx)(Ur,{}),children:(0,v.jsx)(a,{})}),(0,v.jsx)(rr,{open:r,message:t(`common.buildUpdate.message`),actionLabel:t(`common.buildUpdate.reload`),onAction:()=>{window.location.reload()},onClose:()=>{i(!1),n.current=!0}})]})}function ei(){return(0,v.jsx)(jr,{})}const ti=p(`/new`)({component:o(()=>x(()=>import(`./new-C06fdsS8.js`),__vite__mapDeps([0,1,2])),`component`)}),ni=p(`/graphs`)({component:o(()=>x(()=>import(`./graphs-BRy3CI2M.js`),__vite__mapDeps([3,1,2])),`component`),staleTime:1e3*60*5,gcTime:1e3*60*10}),ri=p(`/faq`)({component:o(()=>x(()=>import(`./faq-CSbYZmEz.js`),__vite__mapDeps([4,1,2])),`component`)}),ii=p(`/`)({component:o(()=>x(()=>import(`./routes-CausFUr3.js`),__vite__mapDeps([5,1,2])),`component`)}),ai=p(`/histories/`)({component:o(()=>x(()=>import(`./histories-CZRvrr2c.js`),__vite__mapDeps([6,1,2])),`component`)}),oi=p(`/histories/$id`)({component:o(()=>x(()=>import(`./_id-BygvOl4k.js`),__vite__mapDeps([7,1,2])),`component`)});var si=ti.update({id:`/new`,path:`/new`,getParentRoute:()=>$}),ci=ni.update({id:`/graphs`,path:`/graphs`,getParentRoute:()=>$}),li=ri.update({id:`/faq`,path:`/faq`,getParentRoute:()=>$}),ui=ii.update({id:`/`,path:`/`,getParentRoute:()=>$}),di=ai.update({id:`/histories/`,path:`/histories/`,getParentRoute:()=>$}),fi=oi.update({id:`/histories/$id`,path:`/histories/$id`,getParentRoute:()=>$}),pi={IndexRoute:ui,FaqRoute:li,GraphsRoute:ci,NewRoute:si,HistoriesIdRoute:fi,HistoriesIndexRoute:di};const mi=$._addFileChildren(pi)._addFileTypes();var hi=te({routeTree:mi,basepath:`/cc-war-record`,defaultViewTransition:!0});const gi=()=>(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(u,{router:hi}),!1]}),_i=ie`
  * {
    margin: 0;
    padding: 0;
