import{A as e,D as t,E as n,F as r,I as i,N as a,O as o,P as s,d as c,i as l,k as u,m as d,n as f,o as p,r as m,t as h,u as g,w as _,x as v,z as y}from"./index-D7JXxNJH.js";import{a as b,n as x,t as S}from"./stores-DK9R9pGS.js";var C=y(i()),w=y(a()),T=s.div`
  overflow-x: auto;
...
`,ce=s(j)`
  ...
  color: ${({theme:e})=>e.colors.textSecondary};
  font-style: italic;
`;const L=({histories:e,isLoading:n=!1,onDelete:r})=>{let{t:i}=c(),a=o(),[s,l]=(0,C.useState)(!1),[u,d]=(0,C.useState)(null),f=t=>{let n=e[0]?.uuid;a(t===n?{to:`/`}:{to:`/histories/${t}`})},m=(e,t)=>{d({uuid:e,seasonName:t}),l(!0)},h=()=>{l(!1),d(null)};return n?(0,w.jsx)(T,{children:(0,w.jsxs)(E,{children:[(0,w.jsx)(D,{children:(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.season`)}),(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.date`)}),(0,w.jsx)(O,{children:i(`pages.histories.detail`)})]})}),(0,w.jsx)(k,{children:(0,w.jsx)(se,{children:(0,w.jsx)(ce,{colSpan:3,children:i(`common.loading`)})})})]})}):e.length===0?(0,w.jsxs)(re,{children:[(0,w.jsx)(ie,{children:(0,w.jsx)(_,{name:`history`,size:24})}),(0,w.jsx)(ae,{children:i(`pages.histories.emptyState`)}),(0,w.jsx)(oe,{children:i(`pages.histories.createFirstSeason`)})]}):(0,w.jsxs)(T,{children:[(0,w.jsxs)(E,{children:[(0,w.jsx)(D,{children:(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.season`)}),(0,w.jsx)(O,{children:i(`pages.historyDetail.columns.date`)}),(0,w.jsx)(O,{children:i(`match.actions`)})]})}),(0,w.jsx)(k,{children:e.map(e=>(0,w.jsxs)(A,{children:[(0,w.jsx)(M,{children:e.seasonName}),(0,w.jsx)(N,{children:b(e.createdAt)}),(0,w.jsx)(j,{children:(0,w.jsxs)(I,{children:[(0,w.jsx)(P,{variant:`outline`,icon:(0,w.jsx)(_,{name:`detail`,size:16}),onClick:()=>f(e.uuid),title:i(`pages.histories.detail`)}),(0,w.jsx)(F,{variant:`outline`,icon:(0,w.jsx)(_,{name:`delete`,size:16}),onClick:()=>m(e.uuid,e.seasonName),title:i(`pages.histories.delete`)})]})})]},e.uuid))})]}),(0,w.jsx)(p,{isOpen:s,onClose:h,title:i(`pages.histories.confirmDelete`),children:(0,w.jsxs)(ee,{children:[(0,w.jsx)(te,{children:i(`pages.histories.deleteDescription`,{seasonName:u?.seasonName})}),(0,w.jsxs)(ne,{children:[(0,w.jsx)(t,{variant:`outline`,onClick:h,children:i(`common.cancel`)}),(0,w.jsx)(t,{variant:`primary`,onClick:()=>{u&&(r(u.uuid),l(!1),d(null))},children:i(`character.confirmDelete`)})]})]})})]})};var R=s.div`
  display: flex;
...
`,Ne=s.div`
  ...
  display: flex;
  justify-content: space-between;
`;const Pe=()=>{let{t:e}=c(),{id:n}=u({from:`/histories/$id`}),r=o(),{getHistoryByUuid:i,getMatchRecordsForSeason:a}=S(),s=(0,C.useRef)(null),p=(0,C.useMemo)(()=>i(n),[n,i]);g(p?e(`pages.historyDetail.title`,{seasonName:p.seasonName}):e(`pages.historyDetail.title`,{seasonName:``}));let y=(0,C.useMemo)(()=>a(n),[n,a]),x=(0,C.useMemo)(()=>{if(!p)return[];let e=[];return y.forEach(t=>{let n=p.characterStats.find(e=>e.character.uuid===t.characterUuid)?.character.name||`不明`;e.push({...t,characterName:n})}),p.characterStats.forEach(t=>{t.recentMatches.forEach(n=>{e.some(e=>e.uuid===n.uuid)||e.push({...n,characterName:t.character.name})})}),e.sort((e,t)=>new Date(t.recordedAt).getTime()-new Date(e.recordedAt).getTime())},[p,y]),T=xe({count:x.length,getScrollElement:()=>s.current,estimateSize:()=>56,overscan:5});return p?(0,w.jsxs)(h,{children:[(0,w.jsx)(l,{children:(0,w.jsx)(m,{children:p.seasonName})}),(0,w.jsxs)(f,{children:[e(`pages.historyDetail.totalMatches`,{count:x.length}),` / `,e(`pages.historyDetail.createdDate`),`: `,new Date(p.createdAt).toLocaleDateString(`ja-JP`)]}),(0,w.jsx)(Se,{children:(0,w.jsxs)(Ce,{children:[(0,w.jsxs)(we,{children:[(0,w.jsx)(Z,{children:e(`pages.historyDetail.columns.character`)}),(0,w.jsx)(Z,{width:`120px`,children:e(`pages.historyDetail.columns.job`)}),(0,w.jsx)(Z,{width:`180px`,children:e(`pages.historyDetail.columns.date`)}),(0,w.jsx)(Z,{width:`100px`,children:e(`pages.historyDetail.columns.result`)})]}),x.length>0?(0,w.jsx)(Te,{ref:s,children:(0,w.jsx)(`div`,{style:{height:`${T.getTotalSize()}px`,position:`relative`},children:T.getVirtualItems().map(t=>{let n=x[t.index];return(0,w.jsxs)(Ee,{style:{transform:`translateY(${t.start}px)`,height:`${t.size}px`},children:[(0,w.jsx)(De,{children:n.characterName}),(0,w.jsxs)(ke,{width:`120px`,children:[(0,w.jsx)(d,{job:n.job,size:24}),(0,w.jsx)(Ae,{children:v[n.job].shortName})]}),(0,w.jsx)(Oe,{width:`180px`,children:b(n.recordedAt)}),(0,w.jsx)(Q,{width:`100px`,children:(0,w.jsx)(je,{$isWin:n.isWin,children:n.isWin?e(`pages.historyDetail.results.win`):e(`pages.historyDetail.results.loss`)})})]},n.uuid)})})}):(0,w.jsx)(Me,{children:e(`pages.historyDetail.emptyState`)})]})}),(0,w.jsx)(Ne,{children:(0,w.jsxs)(t,{variant:`outline`,size:`sm`,onClick:()=>r({to:`/histories`}),children:[(0,w.jsx)(_,{name:`back`,size:16}),e(`pages.historyDetail.backToList`)]})})]}):(0,w.jsx)(h,{children:(0,w.jsx)(m,{children:e(`pages.historyDetail.notFound`)})})};var $=s.div`
  max-width: 600px;
  margin: 0 auto;
  padding: ${({theme:e})=>e.spacing[6]};
`,Fe=s.div`
...
`,Be=s.div`
  ...
  margin-bottom: ${({theme:e})=>e.spacing[4]};
  font-size: 0.875rem;
`;const Ve=()=>{let{t:r}=c();g(r(`pages.newSeason.title`));let i=e(),{createHistory:a,error:o,clearError:s,getSortedHistories:l}=S(),[u,d]=(0,C.useState)(``),[h,_]=(0,C.useState)(!1),[v,y]=(0,C.useState)(``),[b,x]=(0,C.useState)(``),[T,E]=(0,C.useState)(!1),D=async e=>{e.preventDefault();let t=u.trim();if(!t){y(r(`pages.newSeason.validationRequired`));return}if(t.length>50){y(r(`pages.newSeason.validationMaxLength`));return}if(y(``),l().length>0){E(!0);return}await O()},O=async()=>{_(!0),s();try{let e=u.trim(),t=a({seasonName:e});x(r(`pages.newSeason.successMessage`,{seasonName:t.seasonName})),setTimeout(()=>{i.navigate({to:`/`})},1500)}catch(e){console.error(`シーズン作成エラー:`,e)}finally{_(!1),E(!1)}},k=()=>{O()},A=()=>{E(!1)},j=()=>{history.back()},M=e=>{d(e.target.value),v&&y(``)},N=l()[0]?.seasonName||``;return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(p,{isOpen:T,onClose:A,title:r(`pages.newSeason.confirmTitle`),confirmText:r(`pages.newSeason.create`),cancelText:r(`pages.newSeason.cancel`),onConfirm:k,confirmType:`danger`,isLoading:h,children:r(`pages.newSeason.confirmDescription`,{seasonName:N})}),(0,w.jsxs)($,{children:[(0,w.jsxs)(Fe,{children:[(0,w.jsx)(m,{children:r(`pages.newSeason.title`)}),(0,w.jsx)(f,{children:r(`pages.newSeason.description`)})]}),(0,w.jsxs)(Ie,{onSubmit:D,children:[(o||v)&&(0,w.jsx)(ze,{children:v||o}),b&&(0,w.jsx)(Be,{children:b}),(0,w.jsx)(Le,{children:(0,w.jsx)(n,{label:r(`pages.newSeason.seasonName`),type:`text`,value:u,onChange:M,placeholder:r(`pages.newSeason.seasonNamePlaceholder`),disabled:h||!!b,fullWidth:!0,required:!0})}),(0,w.jsxs)(Re,{children:[(0,w.jsx)(t,{type:`button`,variant:`outline`,onClick:j,disabled:h||!!b,children:r(`pages.newSeason.cancel`)}),(0,w.jsx)(t,{type:`submit`,disabled:h||!!b||!u.trim(),children:r(h?`pages.newSeason.creating`:`pages.newSeason.create`)})]})]})]})]})};export{Pe as n,U as r,Ve as t};