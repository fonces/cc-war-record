const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/new--ukl_40q.js","assets/react-vendor-D1pS86Oe.js","assets/rolldown-runtime-CIDIeb-o.js","assets/graphs-B3Z9_enf.js","assets/faq-CVFplcGW.js","assets/routes-D9YG7F69.js","assets/histories-BusinmAY.js","assets/_id-LS520qBh.js"])))=>i.map(i=>d[i]);
import{i as e}from"./rolldown-runtime-CIDIeb-o.js";import{C as t,T as n,a as r,c as i,d as a,f as o,g as s,h as c,i as l,l as u,m as d,o as f,p,s as m,u as ee,v as h,w as g,x as te}from"./react-vendor-D1pS86Oe.js";import{a as ne,c as re,i as _,n as ie,o as ae,s as v,t as y}from"./styled-BVM0xVww.js";import{t as oe}from"./jszip-DU7jsDXX.js";import{n as se,t as ce}from"./i18n-THkEc1_o.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var b=e(te()),le=e(t()),ue=e(g()),x=e(n()),de=`modulepreload`,fe=function(e){return`/cc-war-record/`+e},pe={};const S=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=fe(t,n),t in pe)return;pe[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:de,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};var me=y`
  0% {
...
`;const _e=(0,x.memo)(({children:e,suffix:t})=>{let n=(0,x.useRef)(e),[r,i]=(0,x.useState)(`up`);return(0,x.useEffect)(()=>{n.current!==e&&(i(e>n.current?`up`:`down`),n.current=e)},[e]),(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(ge,{$direction:r,children:e},`${e}`),t]})});_e.displayName=`AnimatedNumber`;var ve=v.button`
  display: inline-flex;
  align-items: center;
...
`;const C=(0,x.memo)(({children:e,icon:t,...n})=>(0,b.jsx)(ve,{...n,icon:t,children:t||e}));C.displayName=`Button`;var ye=v.div`
  display: flex;
...
`;const Tt=(0,x.memo)(({job:e,size:t=32,alt:n,className:r})=>{let i=lt(e),a=e,o=e=>{let t=ct(e);return t?t.color:`#6B7280`};return i?(0,b.jsx)(Ct,{src:i,alt:n||e,size:t,className:r,onError:i=>{let s=i.target;s.style.display=`none`;let c=document.createElement(`div`);c.className=r||``,c.style.cssText=`
        ...
        `,c.textContent=a,c.title=n||e,s.parentNode&&s.parentNode.insertBefore(c,s)}}):(0,b.jsx)(wt,{size:t,bgColor:o(e),className:r,title:n||e,children:a})});Tt.displayName=`JobIcon`;var Et=v.img`
  width: ${({size:e})=>e}px;
  height: ${({size:e})=>e}px;
  object-fit: contain;
  display: inline-block;
...
`;const en=(0,x.memo)(({checked:e,onChange:t,disabled:n=!1})=>(0,b.jsx)($t,{type:`checkbox`,checked:e,onChange:t,disabled:n}));en.displayName=`Checkbox`;var tn=y`
  from {
    opacity: 0;
    transform: translateY(-8px);
  }
...
`;const Z=(0,x.memo)(({icon:e,children:t,...n})=>(0,b.jsx)(nr,{variant:`outline`,...n,children:e||t}));Z.displayName=`IconicButton`;var rr=v.div`
  padding: ${({theme:e})=>e.spacing[3]} ${({theme:e})=>e.spacing[4]};
...
`;const or=(0,x.memo)(({type:e=`info`,children:t,onClose:n})=>(0,b.jsxs)(rr,{$type:e,children:[(0,b.jsx)(ir,{children:t}),n&&(0,b.jsx)(ar,{onClick:n,type:`button`,"aria-label":`Close`,children:(0,b.jsx)(O,{name:`close`,size:16})})]}));or.displayName=`Flush`;var sr=e(g()),cr=y`
  from {
...
`;const Wr=({children:e})=>{let[t,n]=(0,x.useState)(!1),r=i(),a=()=>{n(!t)},o=()=>{n(!1)};return(0,b.jsxs)(Ur,{children:[(0,b.jsx)(jr,{onMenuClick:a}),(0,b.jsx)(Br,{isOpen:t,isActivePath:e=>e===`/`?r.pathname===`/`:r.pathname.startsWith(e),onClose:o}),(0,b.jsx)(Vr,{$isOpen:t,onClick:o}),(0,b.jsx)(Hr,{children:e})]})};var Gr=v.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,Xr=v.p`
  ...
  margin: 0.5rem auto;
  line-height: 1.6;
`;const Zr=()=>(0,b.jsx)(X,{children:(0,b.jsxs)(Gr,{children:[(0,b.jsxs)(Kr,{children:[(0,b.jsx)(Jr,{children:`404`}),(0,b.jsx)(Yr,{children:`ページが見つかりません`}),(0,b.jsx)(Xr,{children:`お探しのページは削除されたか、URLが間違っている可能性があります。`})]}),(0,b.jsx)(qr,{children:(0,b.jsx)(c,{to:`/`,children:(0,b.jsx)(C,{children:`ホームに戻る`})})})]})});var Qr=y`
  0%, 100% {
    transform: translateY(0);
  }
  50% {
...
`;const ai=(0,x.memo)(({icon:e=`home`})=>{let{t}=K(),n=s();return(0,b.jsxs)(ei,{children:[(0,b.jsx)(ti,{children:(0,b.jsx)(O,{name:e,size:32})}),(0,b.jsx)(ni,{children:t(`pages.home.noSeason`)}),(0,b.jsx)(ri,{children:t(`pages.home.createFirstSeason`)}),(0,b.jsxs)(ii,{onClick:()=>{n({to:`/new`})},children:[(0,b.jsx)(O,{name:`add`,size:20,color:`white`}),t(`pages.home.createSeason`)]})]})});ai.displayName=`EmptyState`;var oi=v.div`
  display: flex;
  justify-content: center;
  align-items: center;
  min-height: 60vh;
...
`,ci=v.p`
  ...
  color: ${({theme:e})=>e.colors.textSecondary};
  font-size: 0.875rem;
`;const li=()=>(0,b.jsx)(oi,{children:(0,b.jsxs)(`div`,{children:[(0,b.jsx)(si,{}),(0,b.jsx)(ci,{children:`Loading...`})]})}),ui=v.form`
  background: ${({theme:e})=>e.gradients.glass};
  backdrop-filter: ${({theme:e})=>e.blur.md};
  padding: ${({theme:e})=>e.spacing[8]};
  border-radius: ${({theme:e})=>e.borderRadius.lg};
