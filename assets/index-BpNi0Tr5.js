const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/new-CrxQHi0H.js","assets/react-vendor-D1pS86Oe.js","assets/rolldown-runtime-CIDIeb-o.js","assets/graphs-DjVKYZk1.js","assets/faq-BP8VkDgJ.js","assets/routes-CtO_SHDW.js","assets/histories-sE0bGW6o.js","assets/_id-BHu82eMB.js"])))=>i.map(i=>d[i]);
  ...
  * {
  ...
  @supports (padding-top: env(safe-area-inset-top)) {
    ...
    body::before {
      ...
      background: ${({theme:e})=>e.isDark?`linear-gradient(180deg, rgba(10, 10, 11, 0.95) 0%, rgba(38, 161, 223, 0.12) 50%, rgba(243, 99, 70, 0.12) 100%)`:`linear-gradient(180deg, rgba(255, 255, 255, 0.95) 0%, rgba(38, 161, 223, 0.08) 50%, rgba(243, 99, 70, 0.08) 100%)`};
      backdrop-filter: saturate(180%) ${({theme:e})=>e.blur.xl};
      -webkit-backdrop-filter: saturate(180%) ${({theme:e})=>e.blur.xl};
      border-bottom: 0.5px solid ${({theme:e})=>e.isDark?`rgba(255, 255, 255, 0.1)`:`rgba(0, 0, 0, 0.05)`};
      box-shadow: ${({theme:e})=>e.isDark?`0 1px 0 0 rgba(255, 255, 255, 0.05), inset 0 -1px 0 0 rgba(0, 0, 0, 0.3)`:`0 1px 0 0 rgba(255, 255, 255, 0.8), inset 0 -1px 0 0 rgba(0, 0, 0, 0.05)`};
      z-index: 9999;
      pointer-events: none;
    }
    ...
    body::after {
      ...
      background: ${({theme:e})=>e.isDark?`linear-gradient(0deg, rgba(10, 10, 11, 0.95) 0%, rgba(24, 24, 27, 0.8) 100%)`:`linear-gradient(0deg, rgba(255, 255, 255, 0.95) 0%, rgba(249, 250, 251, 0.8) 100%)`};
      backdrop-filter: saturate(180%) ${({theme:e})=>e.blur.xl};
      -webkit-backdrop-filter: saturate(180%) ${({theme:e})=>e.blur.xl};
      border-top: 0.5px solid ${({theme:e})=>e.isDark?`rgba(255, 255, 255, 0.1)`:`rgba(0, 0, 0, 0.05)`};
      box-shadow: ${({theme:e})=>e.isDark?`0 -1px 0 0 rgba(255, 255, 255, 0.05), inset 0 1px 0 0 rgba(0, 0, 0, 0.3)`:`0 -1px 0 0 rgba(255, 255, 255, 0.8), inset 0 1px 0 0 rgba(0, 0, 0, 0.05)`};
      z-index: 9999;
      pointer-events: none;
    }
