import{A as e,C as t,D as n,E as r,I as i,N as a,P as o,S as s,_ as c,b as l,c as u,d,g as f,h as p,i as m,l as h,m as g,n as _,o as v,p as y,r as b,s as x,t as S,u as ee,v as C,w,x as T,y as te,z as E}from"./index-B1W7Mw1R.js";import{n as ne,t as D}from"./stores-DKKu7yjr.js";import{t as re}from"./EmptyState-B-Hk0Csb.js";var O=E(i()),k=E(a()),A=o.div`
...
`,se=o.div`
  ...
  color: ${({theme:e})=>e.colors.textSecondary};
  font-size: 0.875rem;
`;const Q=({usedJobs:e,jobSummaries:t,onAddWin:n,onAddLoss:r,onRevertLast:i,map:a})=>{let{t:o}=d(),s=!!(n||r||i);return(0,k.jsx)(ae,{children:(0,k.jsxs)(oe,{children:[(0,k.jsx)(H,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(W,{children:o(`match.job`)}),(0,k.jsx)(W,{children:o(`match.totalMatches`)}),(0,k.jsx)(W,{children:o(`match.win`)}),(0,k.jsx)(W,{children:o(`match.loss`)}),(0,k.jsx)(W,{children:o(`match.winRate`)}),(0,k.jsx)(W,{children:s&&a?o(`match.actions`):``})]})}),(0,k.jsx)(G,{children:e.length===0?(0,k.jsx)(K,{children:(0,k.jsx)(q,{colSpan:s?6:5,children:(0,k.jsx)(se,{children:o(`match.pleaseRegisterJob`)})})}):e.map(e=>{let s=t.find(t=>t.job===e)||{job:e,totalMatches:0,wins:0,losses:0,winRate:0};return(0,k.jsxs)(K,{children:[(0,k.jsx)(J,{children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(g,{job:s.job,size:32}),s.job]})}),(0,k.jsx)(q,{children:s.totalMatches}),(0,k.jsx)(q,{children:s.wins}),(0,k.jsx)(q,{children:s.losses}),(0,k.jsx)(q,{children:0<s.totalMatches?(0,k.jsxs)(Y,{winRate:s.winRate,children:[s.winRate,`%`]}):(0,k.jsx)(`span`,{children:`--%`})}),(0,k.jsx)(q,{children:a?(0,k.jsxs)(X,{children:[n&&(0,k.jsx)(Z,{variant:`win`,onClick:()=>n(s.job,a),title:o(`match.addWin`),children:`W`}),r&&(0,k.jsx)(Z,{variant:`defeat`,onClick:()=>r(s.job,a),title:o(`match.addDefeat`),children:`D`}),s.totalMatches>0&&i?(0,k.jsx)(Z,{variant:`ghost`,icon:(0,k.jsx)(w,{name:`revert`,size:16}),onClick:()=>i(s.job,a),title:o(`match.rollback`)}):(n||r)&&(0,k.jsx)(`div`,{style:{width:`32px`}})]}):null})]},e)})})]})})},ce=o.span`
  display: inline-flex;
  align-items: center;
